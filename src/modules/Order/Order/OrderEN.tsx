...
import ConfirmationWindow from "../ConfirmationWindow/ConfirmationWindowEN";
            ...
            >
                {({ isSubmitting, isValid, errors, touched }) => (
                    <Forms isVisible={isVisible}>
                        ...
                        <Structure>
                            <Block>
                                <Label htmlFor="name" className={`${errors.name && touched.name ? 'error' : ''}`}>Your name:</Label>
                                <Fields className={`${roboto.className} ${errors.name && touched.name ? 'error' : ''}`} type="text" name="name" placeholder={'Full Name'} />
                            ...
                            <Block>
                                <Label htmlFor="phoneNumber" className={`${errors.phoneNumber && touched.phoneNumber ? 'error' : ''}`}>Phone number:</Label>
                            ...
                            <Block>
                                <Label htmlFor="telegramNick">Telegram <Span>(optional)</Span></Label>
                            ...
                            <Block>
                                <Label htmlFor="location" className={`${errors.location && touched.location ? 'error' : ''}`}>Delivery address:</Label>
                                <Fields className={`${roboto.className} ${errors.location && touched.location ? 'error' : ''}`} type="text" name="location" placeholder={'Region'} />
                                {errors.location && touched.location && (
                                    <Error name="location" component="div" className="error" />
                                )}
                            </Block>
                            <Block>
                                <Fields className={`${roboto.className} ${errors.city && touched.city ? 'error' : ''}`} type="text" name="city" placeholder={'City / Village'} />
                                {errors.city && touched.city && (
                                    <Error name="city" component="div" className="error" />
                                )}
                            </Block>
                            <Block>
                                <Fields className={`${roboto.className} ${errors.post && touched.post ? 'error' : ''}`} type="text" name="post" placeholder={'Nova Poshta branches / Postmate'} />
                        ...
                        <UnderText className={roboto.className}>
                            After placing an order, our team will contact you within a day
                        </UnderText>
